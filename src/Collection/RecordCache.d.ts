declare module '@code-oss-org/watermelondb/Collection/RecordCache' {
  import { Model, RawRecord, RecordId, TableName } from '@code-oss-org/watermelondb'
  import { CachedQueryResult } from '@code-oss-org/watermelondb/adapters/type'
